...
public:
    ...
    int run() {
        ...
        const std::vector<std::string> tabs{"  CPU  ","  MEM  ","  NET  "," DISK  "," PROCS "};
        ...
        auto component = CatchEvent(renderer, [&](Event e) -> bool {
            ...
            if (e == Event::ArrowDown || e == Event::Character('j')) { ++proc_scroll; return true; }
            if (e == Event::ArrowUp   || e == Event::Character('k')) { if (proc_scroll > 0) --proc_scroll; return true; }
